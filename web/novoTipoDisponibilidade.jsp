...
<html>
    <head>
        ...
        <link href="css/bootstrap.min.css" rel="stylesheet" media="screen">
         <title>JCarbon - Novo Tipo de Disponibilidade</title>
    </head>
    <body>
        <%@include  file="menu.jsp" %>
        <div class="container">
            <h1>Novo Tipo de Disponibilidade do Trabalho Científico</h1>
           <% TipoDisponibilidade objeto_tipoDisponibilidade = (TipoDisponibilidade) request.getAttribute("tipoDisponibilidade");%>
            ...
            <%}%>           
        <form action="createTipoDisponibilidade" method="POST" class="form-horizontal"  accept-charset="iso-8859-1,utf-8">
