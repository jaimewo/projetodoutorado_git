        ...
        <div class="container">
            ...
            <form action="#" method="POST" id="form_local" class="form-horizontal"  accept-charset="iso-8859-1,utf-8">
                ...
                <div class="field control-group">
                    <label for="opcaoA" class="control-label">Você escolheu a Opção 4</label>
                    <label for="opcaoB" class="control-label">Desejo utilizar uma equação padrão do sistema para estimar o Volume</label>
                </div>
                ...
                <div class="field control-group">
                    <label for="equacaoVolumePadrao" class="control-label">Equação de Volume Padrão para este local:</label>
                    <div class="controls">
                        <input type="text" name="equacaoVolumePadrao" id="equacaoVolumePadrao" value="<%=equacaoVolumePadrao%>" />
                    </div>
                </div>
