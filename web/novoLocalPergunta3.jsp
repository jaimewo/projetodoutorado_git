        ...
        <div class="container">
            ...
            <form action="#" method="POST" id="form_local" class="form-horizontal"  accept-charset="iso-8859-1,utf-8">
                ...
                <div class="field control-group">
                    <label for="opcaoA" class="control-label">Você escolheu a Opção 3</label>
                    <label for="opcaoB" class="control-label">Tenho o Volume de Parcelas para estimar o local</label>
                </div>
