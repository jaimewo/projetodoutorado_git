 ...
 * @author jaime
 */
public class createLocalBaixarModeloArvore extends HttpServlet {
    ...
    public String gravarPlanilhaExemplo(int idLocal) throws SQLException, BiffException, Exception {
        ...
        return arvore.gravarPlanilhaExemplo(local);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(createLocalBaixarModeloArvore.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
